...
`.claude/` と `.github/workflows/` の一部、`web/scripts/lint-comments.ts` と `web/tests/lint-comments.test.ts`、`scripts/lint-vocabulary.sh` と `.githooks/` の2本、`.claude/rules/` は共有の雛形からの写しである。
