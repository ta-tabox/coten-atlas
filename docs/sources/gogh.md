...
値は変わらなかった。
2026-09-11 に人間が仮決定を採用して決着させ、見直しを [#187](https://github.com/ta-tabox/coten-atlas/issues/187)（ゴッホ（gogh）の代表点をアルルとパリのどちらにするか）へ切り出した。

| 論点 | 仮決定 | 覆りうる根拠 |
|---|---|---|
| 代表点 | アルル（事績の中心） | 描いた油彩の数で数えればパリが最も多い。浮世絵と印象派との出会いを主な事績と見ればパリ、《星月夜》を代表作と見ればサン＝レミになる。見直しは #187 で行う |
...
| [#187（見直し）](https://github.com/ta-tabox/coten-atlas/issues/187) | 採用した仮決定を人間が見直す論点と案 |
