...
2026-09-12 に人間が、決着させた値に残る論点を見直すと決め、見直しを [#218](https://github.com/ta-tabox/coten-atlas/issues/218)（項羽と劉邦（kou-to-ryuho）の代表点を彭城と咸陽のどちらにするか）へ切り出した。

| 論点 | 仮決定 | 覆りうる根拠 |
|---|---|---|
| 劉邦の生年 | -256 | 前247年説が並立する |
| 代表点 | `pengcheng`（彭城） | 彭城は項羽の都で、劉邦の出身は沛県である。咸陽と長安も候補に挙がった。見直しは #218 で行う |
...
| [#218（見直し）](https://github.com/ta-tabox/coten-atlas/issues/218) | 人間が決着させた値を見直す論点と案 |
