...
値は変わらない。
2026-09-11 に人間が仮決定を採用して決着させ、見直しを [#177](https://github.com/ta-tabox/coten-atlas/issues/177)（三蔵法師玄奘（sanzohoshi-genjo）の代表点を長安とナーランダのどちらにするか）へ切り出した。

| 論点 | 仮決定 | 覆りうる根拠 |
|---|---|---|
| `start` | 602 | 600 年説と 598 年説が並立している |
| 代表点 | `changan`（長安） | 事績の中心を旅の目的の学びに置けばナーランダ、晩年の翻訳に置けば玉華宮になる。見直しは #177 で行う |
